...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    if ([[UIDevice currentDevice] userInterfaceIdiom] == UIUserInterfaceIdiomPhone) {
        self.viewController = [[DTVViewController alloc] initWithNibName:@"DTVViewController_iPhone" bundle:nil];
    } else {
        self.viewController = [[DTVViewController alloc] initWithNibName:@"DTVViewController_iPad" bundle:nil];
    }
